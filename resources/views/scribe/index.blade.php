    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-auth-register">Регистрация нового пользователя

Зарегистрировать нового пользователя и вернуть его данные.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-auth-login">
                                <a href="#auth-POSTapi-auth-login">Авторизация пользователя

Вернуть токен для аутентифицированного пользователя.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="tenders">
                    <a href="#tenders">Tenders</a>
                                ...
                                <a href="#tenders-POSTapi-tenders">Создать новый тендер

Создаёт новый тендер в системе.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tenders-GETapi-tenders">
                                <a href="#tenders-GETapi-tenders">Получить список тендеров

Возвращает список тендеров с возможностью фильтрации по названию и дате.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tenders-GETapi-tenders--id-">
                                <a href="#tenders-GETapi-tenders--id-">Получить информацию о тендере

Возвращает данные одного тендера по его ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-POSTapi-auth-register">Регистрация нового пользователя

Зарегистрировать нового пользователя и вернуть его данные.</h2>
...
<span id="example-responses-POSTapi-auth-register">
            <blockquote>
            <p>Example response (201, Успешно):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Пароль. Example: <code>password</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-auth-login">Авторизация пользователя

Вернуть токен для аутентифицированного пользователя.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email пользователя. Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Пароль. Example: <code>password</code></p>
                ...
                <h1 id="tenders">Tenders</h1>
                                ...
                                <h2 id="tenders-POSTapi-tenders">Создать новый тендер

Создаёт новый тендер в системе.</h2>
...
<form id="form-POSTapi-tenders" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-tenders');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-tenders"
                    onclick="cancelTryOut('POSTapi-tenders');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Внешний код. Example: <code>152467180</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Номер. Example: <code>17660-2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Статус. Example: <code>Закрыто</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Лабораторная посуда"
               data-component="body">
    <br>
<p>Название. Example: <code>Лабораторная посуда</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>datetime</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Дата в формате Y-m-d H:i:s. Example: <code>2024-07-01 12:00:00</code></p>
        </div>
        </form>

                    <h2 id="tenders-GETapi-tenders">Получить список тендеров

Возвращает список тендеров с возможностью фильтрации по названию и дате.</h2>
...
<form id="form-GETapi-tenders" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tenders');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tenders"
                    onclick="cancelTryOut('GETapi-tenders');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Фильтр по названию. Example: <code>оборудование</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>date Дата в формате YYYY-MM-DD. Example: <code>2024-07-01</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<p>Must be a valid date in the format <code>Y-m-d</code>. Example: <code>2025-07-01</code></p>
                    ...
                    <h2 id="tenders-GETapi-tenders--id-">Получить информацию о тендере

Возвращает данные одного тендера по его ID.</h2>
...
<form id="form-GETapi-tenders--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tenders--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tenders--id-"
                    onclick="cancelTryOut('GETapi-tenders--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID тендера. Example: <code>1</code></p>
            </div>
                    </form>
